...
QuantumSyncEvolveOpticalDepthFunc (QuantumSynchrotronEvolveOpticalDepth evolve_functor,
                                   ...
                                   int a_offset):
    m_evolve_functor{evolve_functor},
    m_ux{ux},
    m_uy{uy},
    m_uz{uz},
